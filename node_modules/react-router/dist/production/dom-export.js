...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunk6XRGXNVQjs.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
      ...
      () => (
        ...
        Promise.resolve(payloadPromise).then(async (payload) => {
          if (payload.type === "redirect") {
            ...
            _chunk6XRGXNVQjs.validateNavigationTarget.call(void 0, 
              payload.location,
              location2,
            ...
            if (payload.reload || isExternalLocation(location2)) {
              if (_chunk6XRGXNVQjs.hasInvalidProtocol.call(void 0, location2)) {
...
function createRouterFromPayload({
  ...
  _chunkSJHDA7OGjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunk6XRGXNVQjs.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunk6XRGXNVQjs.createBrowserHistory.call(void 0, ),
    hydrationData: _chunkSJHDA7OGjs.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunk6XRGXNVQjs.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunk6XRGXNVQjs.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunk6XRGXNVQjs.getSingleFetchDataStrategyImpl.call(void 0, 
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, trailingSlashAware, targetRoutes) => {
    ...
    let url = _chunk6XRGXNVQjs.singleFetchUrl.call(void 0, request.url, basename, trailingSlashAware, "rsc");
    if (request.method === "GET") {
      url = _chunk6XRGXNVQjs.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunk6XRGXNVQjs.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunk6XRGXNVQjs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunk6XRGXNVQjs.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunk6XRGXNVQjs.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunk6XRGXNVQjs.setIsHydrated.call(void 0, );
  }, []);
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunk6XRGXNVQjs.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunkSJHDA7OGjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunk6XRGXNVQjs.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunk6XRGXNVQjs.shouldHydrateRouteLoader.call(void 0, 
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunk6XRGXNVQjs.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunk6XRGXNVQjs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
...
async function fetchAndApplyManifestPatches(paths, createFromReadableStream, fetchImplementation, signal) {
  paths = _chunk6XRGXNVQjs.getPathsWithAncestors.call(void 0, paths);
...
function normalizeRedirectLocation(location2) {
  if (_chunk6XRGXNVQjs.PROTOCOL_RELATIVE_URL_REGEX.test(location2)) {
    let path = _chunk6XRGXNVQjs.resolvePath.call(void 0, location2);
